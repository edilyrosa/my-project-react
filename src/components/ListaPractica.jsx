...
export default function Lista({showActions=true, bigSize=true}){ //Default es /carrito
    //!const { cart, removeFromCart, updateQuantity, getCartTotal} = useCart();
    //la cart es una verdad actualizada del contexto, por eso lo puedo llamar desde aca.
    const cart = [
   ...
   const updateQuantity = () => { alert(`Cantidad del Producto en el carrito CAMBIO`)}
    ...
    return(
        <div className="rounded-lg shadow-md p-6">
            ...
            {/*//! Cada registro crea un border-botom cuyo separador sumula una list */}
            {cart.map((item) => (
                <div 
                    key={item.id} 
                ...
                {/*//! al lado de la img un ele de 3 lineas con: nombre, precio y cantidad */}
